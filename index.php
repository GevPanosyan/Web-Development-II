<?php 
	...
	if ($_GET["submit"]!="") {
		...
		$link = mysqli_connect("localhost","root","usbw","gevorg");
		$sql = "INSERT INTO `products`(`title`,`image`,`price`,`info`) VALUES('$title', '$image', $price, '$info')";
		$result = mysqli_query($link, $sql);
		mysqli_close($link);
	}
 ?>
				...
				<?php while ($r = mysqli_fetch_assoc($result)) {?>
					<div class="item">
						...
						<div class="pref">
							...
							<button type="button" class="rm"><a href="product.php?id=<?php echo $r['id'] ?>">Read More</a></button>
						</div>
					</div>
			 	<?php } ?>
			</div>
